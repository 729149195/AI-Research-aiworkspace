...
这是独立项目仓库。隐藏的 `.gitignore` 和 `.github/` 负责版本管理与持续集成，所有业务内容集中于上面的三个入口。无需 Node.js 或 npm。
...
仓库地址为 [729149195/AI-Research-aiworkspace](https://github.com/729149195/AI-Research-aiworkspace)。直接按下方命令克隆即可使用。已有论文无需重建，参见 [接续已有论文](aiworkspace/docs/NEW_REPOSITORY.md)。
